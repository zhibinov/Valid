...
const downloadBlock = document.querySelectorAll('.b-main__download-block');

downloadBlock.forEach(el => downFunc(el));

function downFunc(item) {

  item.addEventListener('click', (event) => {
    const delDownload = item.querySelector('.b-main__del');
    // const delDownload = document.querySelector('.b-main__del');
    const downloadBox = item.querySelector('.b-main__download-box');
    // const forms = document.querySelectorAll('form');
    const inputFile = item.querySelectorAll('.b-main__input-file');

    inputFile.forEach(function (el) {

      let textSelector = item.querySelector('.b-main__download-text');
      let fileList;
