...
class Validator {
    ...
    _validateBox() {
        const checkboxBox = document.querySelectorAll('.b-main__checkbox-box');
        
        checkboxBox.forEach(el => checkValid(el));

        function checkValid(el) {
            const checkboxMain = el.querySelectorAll('input:checked');
                if (checkboxMain.length < 1) {
